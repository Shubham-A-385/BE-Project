...
class saferoute : AppCompatActivity() {
   ...
   lateinit var desti:EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiValueMap["arvindgavalicollegesatara"] = ArrayList()
        multiValueMap["arvindgavalicollegesatara"]!!.add("viaNH48-MumbaiHwy/MumbaiHwy/Pune-BengaluruHwy")
        multiValueMap["arvindgavalicollegesatara"]!!.add("National-Hhighway-48-chennai-delhi")

        multiValueMap["arvindgavalicollegerajwada"] = ArrayList()
        multiValueMap["arvindgavalicollegerajwada"]!!.add("via-ITI-Road")
        multiValueMap["arvindgavalicollegerajwada"]!!.add("via-SH-58-National-Highway")

        multiValueMap["satarapanchwad"] = ArrayList()
        multiValueMap["satarapanchwad"]!!.add("via-NH-48")
        multiValueMap["satarapanchwad"]!!.add("via-raygaon-wadhe")
